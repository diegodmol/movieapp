...
import com.movieapp.di.NetworkModule_ProvideAuthInterceptorFactory;
import com.movieapp.di.NetworkModule_ProvideLoggingInterceptorFactory;
import com.movieapp.di.NetworkModule_ProvideOkHttpClientFactory;
import com.movieapp.di.NetworkModule_ProvideRetrofitFactory;
import com.movieapp.di.NetworkModule_ProvideTmdbApiServiceFactory;
...
import com.movieapp.presentation.screen.detail.MovieDetailViewModel;
import com.movieapp.presentation.screen.detail.MovieDetailViewModel_HiltModules;
import com.movieapp.presentation.screen.home.HomeViewModel;
import com.movieapp.presentation.screen.home.HomeViewModel_HiltModules;
...
public final class DaggerMovieApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MovieApp_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(2).put(LazyClassKeyProvider.com_movieapp_presentation_screen_home_HomeViewModel, HomeViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_movieapp_presentation_screen_detail_MovieDetailViewModel, MovieDetailViewModel_HiltModules.KeyModule.provide()).build());
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_movieapp_presentation_screen_detail_MovieDetailViewModel = "com.movieapp.presentation.screen.detail.MovieDetailViewModel";

      static String com_movieapp_presentation_screen_home_HomeViewModel = "com.movieapp.presentation.screen.home.HomeViewModel";

      @KeepFieldType
      MovieDetailViewModel com_movieapp_presentation_screen_detail_MovieDetailViewModel2;

      @KeepFieldType
      HomeViewModel com_movieapp_presentation_screen_home_HomeViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends MovieApp_HiltComponents.ViewModelC {
    ...
    private SearchMoviesUseCase searchMoviesUseCase() {
      return new SearchMoviesUseCase(singletonCImpl.bindMovieRepositoryProvider.get());
    }

    private GetMovieDetailUseCase getMovieDetailUseCase() {
      return new GetMovieDetailUseCase(singletonCImpl.bindMovieRepositoryProvider.get());
    }
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.movieDetailViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(2).put(LazyClassKeyProvider.com_movieapp_presentation_screen_home_HomeViewModel, ((Provider) homeViewModelProvider)).put(LazyClassKeyProvider.com_movieapp_presentation_screen_detail_MovieDetailViewModel, ((Provider) movieDetailViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.movieapp.presentation.screen.home.HomeViewModel 
          return (T) new HomeViewModel(viewModelCImpl.getMoviesUseCase(), viewModelCImpl.searchMoviesUseCase());

          case 1: // com.movieapp.presentation.screen.detail.MovieDetailViewModel 
          return (T) new MovieDetailViewModel(viewModelCImpl.getMovieDetailUseCase(), viewModelCImpl.savedStateHandle);
  ...
  private static final class SingletonCImpl extends MovieApp_HiltComponents.SingletonC {
    ...
    private void initialize() {
      ...
      this.provideTmdbApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<TmdbApiService>(singletonCImpl, 1));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.movieapp.data.repository.MovieRepositoryImpl 
          return (T) new MovieRepositoryImpl(singletonCImpl.provideTmdbApiServiceProvider.get());

          case 1: // com.movieapp.data.remote.api.TmdbApiService 
          return (T) NetworkModule_ProvideTmdbApiServiceFactory.provideTmdbApiService(singletonCImpl.provideRetrofitProvider.get());
